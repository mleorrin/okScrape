...
def main():
    ...
    name = nalList[0]
    try:
        print('Name:\n     %s %s, %s' %(name[0],name[1][0],name[2]))
    except IndexError:
        print('Name:\n     %s, %s' %(name[0],name[1]))
    print('Age:\n     ',nalList[1])
    print('Current Location:\n     ',nalList[2])
    print('Employment History:')
    for i in historyWork:
        print('     ',i)
...
Sample output:
enter link. 
https://ok.ru/profile/479320805240
Name:
     Петрова(Полянская), Ирина
Age:
      53
Current Location:
       Кыргызстан
...
Current Location:
       Россия
Employment History:
      ['НПО Тайфун, г. Обнинск (Калужская область), Россия', '2012 - инженер']
      ["НПО Тайфун, г. Обнинск (Калужская область), Россия'>ГУ НПО Тайфун", '2012 - Present']
      ['полигон НС РАН, Бишкек (Пишпек, Фрунзе), Кыргызстан', '1992 - 2011']
      ['НС РАН, Бишкек (Пишпек, Фрунзе), Кыргызстан', '1992 - 2011']
      ['научный полигон ИВТАН, Бишкек (Пишпек, Фрунзе), Кыргызстан', '1992 - 2011']
      ['завод Физприборы, Бишкек (Пишпек, Фрунзе), Кыргызстан', '1985 - 1991']
      [" Физприборы, Бишкек (Пишпек, Фрунзе), Кыргызстан'>завод  Физприборы", '1982 - 1991']
      ['Приборостроительный завод им.50-летия СССР., Бишкек (Пишпек, Фрунзе), Кыргызстан', '1982 - 1991']
Education History:
      ['КФУ, институт физики, Казань, Россия', '1981 - 1986']
      ['Бишкекский вечерний приборостроительный техникум, Бишкек (Пишпек, Фрунзе), Кыргызстан', '1985 - 1988']
Continue? (1/0)0
'''
